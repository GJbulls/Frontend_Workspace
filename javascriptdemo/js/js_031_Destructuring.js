...
/*
Destructuring(구조 분행 할당)
: Destructuring(디스트럭쳐링)은 structuring(구조화)된 배열 또는 개체를 Destructuring(비구조화)히여
개별적으로 변수에 할당하는 개념이다
*/
...
//////////////////////////////////////////////////////////////////////////
//member변수에서 데이터를 추출하여 '고수 고객님은 서울에 거주합니다.' 출력하세요.
let member = { hname: '고수', address: { zipCode: '562-143', city: '서울' } };
